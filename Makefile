...
test:
	${ENGINE} run -e ROCKET_LOG_LEVEL=debug -e ROCKET_ADDRESS=0.0.0.0 -e CACHE_TTL=60 -e S3_PUBLIC="https://haikuports-repository.cdn.haiku-os.org/" -e BRANCH_ALIASES="master:r1beta5,r1beta4,r1beta3" -v ./secrets-mount:/run/secrets -P ${REGISTRY}/hpkgbouncer:$(VERSION)
